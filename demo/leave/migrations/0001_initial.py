    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resion', models.CharField(max_length=256, verbose_name='leave事由')),
                ('file_url', models.CharField(max_length=256, verbose_name='上传附件')),
                ('depart_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hr.department', verbose_name='Department')),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'leave类别',
                'verbose_name_plural': 'leave类别',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dep_approved', models.BooleanField(default=False, verbose_name='Department审核')),
                ('dep_approved_time', models.DateTimeField(blank=True, null=True, verbose_name='Department领导审核时间')),
                ('dep_approved_comment', models.CharField(blank=True, max_length=256, null=True, verbose_name='Department领导审核意见')),
            ...
            options={
                'verbose_name': 'leave过程',
                'verbose_name_plural': 'leave过程',
        ...
        migrations.AddField(
            model_name='leave',
            name='req_class',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='leave.Leave_class', verbose_name='leave类别'),
        ),
    ]
